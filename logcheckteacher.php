...
header( 'Location: http://localhost/learning/teacherlogin.php' );
...
$query_user = sprintf("SELECT teacherid,user FROM Teachers WHERE user = %s", GetSQLValueString($_SESSION['user'], "text"));
